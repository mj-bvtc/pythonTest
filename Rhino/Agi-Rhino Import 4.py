...
def FindOBJs():
    ...
    agiFolder= r"V:\Field Survey\Chatsworth Apartments\Agi-Renders"
    ...
    for dirpath, dirname, filename in walk:
        for file in filename:
            ...
            if ext.upper() == "OBJ":
                ...
                objs.append(file)
                full_objs.append(dirpath+'\\'+filename)
                
            if ext.upper() == "3DM":
                print "Rhino found: " + file
                rhinos.append(file)
                full_rhinos.append(dirpath+'\\'+filename)
            
            if ext.upper() == "WRL":
                print "WRL found: " + file
                wrls.append(file)
                full_wrls.append(dirpath+'\\'+filename)
